...
class DQN:
    ...
    def create_nets(self):
        ...
        with tf.variable_scope('online_net'):
            ...
            # get Q(state)
            self.q_eval = tf.layers.dense(e3,self.action_dim,kernel_initializer=w_initializer,bias_initializer=b_initializer)
        ...
        with tf.variable_scope('target_net'):
            ...
            # get Q(state)
            self.q_target = tf.layers.dense(t3,self.action_dim,kernel_initializer=w_initializer,bias_initializer=b_initializer)
